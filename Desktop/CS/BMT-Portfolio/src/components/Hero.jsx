export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20">
      <p className="text-xs tracking-[0.3em] uppercase text-emerald-400/80 mb-6">
      ...
      <div className="w-12 h-px bg-emerald-600 mx-auto mb-6" />
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-emerald-500/60">
